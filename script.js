...
// const changeStatus = function (localArray) {
//   if (localStorage.getItem("localstorage")) {
//     localArray.forEach((obj) => {
//       let elementId = obj.id;
//       let task = document.getElementById(`${elementId}`);
// console.log(obj);
...
//       "afterend",
//       `
// <div class="bg-[#FFFFFF] p-[16px] rounded-[12px] mt-[16px] cursor-pointer" id="${obj.id}">
// <div>
...
//   </div>
//   <div>
//     <p class="text-[14px] text-[#2B1887]">${obj.client}</p>
//   </div>
// </div>
// </div>`
//     );
...
const submitPopUp = function () {
  const loadData = localStorage.getItem("localstorage");
